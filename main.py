# ======================================================================
# 🤖 CRYPTO ORÁCULO — GOD MODE FINAL v4.0 (Render FIX)
# Incluye servidor Flask interno para satisfacer a Render
# ======================================================================
...
@app.route("/")
def home():
    return "CRYPTO ORÁCULO GOD MODE corriendo"
...
# ===========================
def iniciar_bot():
    send("🚀 CRYPTO ORÁCULO GOD MODE FINAL v4.0 ACTIVADO")
    while True:
